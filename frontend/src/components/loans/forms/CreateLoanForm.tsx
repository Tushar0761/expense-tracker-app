...
interface CreateLoanDialogProps {
  ...
  onBorrowerAdded?: (newBorrower: { id: number; borrowerName: string }) => void;
}
      ...
      <DialogContent className="max-w-lg">
        ...
        >
            ...
            <div className="flex gap-2">
              ...
              <AddBorrowerDialog
                onSuccess={(newBorrower) => {
                  ...
                  form.setValue('borrowerId', String(newBorrower.id));
                }}
              />
            </div>
          ...
          <div>
            ...
            <Select
              onValueChange={(val) =>
                form.setValue('status', val as LoanFormValues['status'])
              }
              value="ACTIVE"
            >
              <SelectTrigger>
